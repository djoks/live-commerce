...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
    <div class="text-center mb-12">
        <h2 class="font-bold text-3xl md:text-[40px] text-zinc-800 dark:text-white mb-4">{{ __('Browse The Range') }}</h2>
        <p class="text-zinc-600 dark:text-zinc-400 text-lg md:text-xl">{{ __('Lorem ipsum dolor sit amet, consectetur adipiscing elit.') }}</p>
    </div>
